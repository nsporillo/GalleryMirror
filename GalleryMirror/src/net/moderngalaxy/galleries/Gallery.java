package net.moderngalaxy.galleries;

import static java.nio.file.StandardCopyOption.REPLACE_EXISTING;
import static net.moderngalaxy.downloads.Metadata.*;
...
import net.moderngalaxy.downloads.Image;
import net.moderngalaxy.downloads.Media;
import net.moderngalaxy.downloads.Metadata;
import net.moderngalaxy.downloads.Video;
